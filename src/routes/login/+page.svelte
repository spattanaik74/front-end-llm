  ...
  async function handleLogin() {
    try {
      ...
      if (response.ok) {
        ...
        window.location.href = '/home'; // Redirect to the books page
      } else {
...
<main class="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl">
  ...
  <div class="mt-4 text-gray-600 links">
    ...
    <p class="mt-4 text-gray-600">Dont have account? <a href="/register" class="text-indigo-600">Register Here</a>.</p>
